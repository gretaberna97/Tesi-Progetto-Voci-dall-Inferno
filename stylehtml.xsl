<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="//tei:fileDesc">
        ...
        <table> 
            <tr>
                <th><xsl:value-of select="tei:titleStmt/tei:respStmt[1]/tei:resp" /> :</th> <td> <xsl:value-of select="tei:titleStmt/tei:respStmt[1]/tei:name" /> </td>
            </tr>
            <tr>
                <th><xsl:value-of select="//tei:respStmt[2]/tei:resp" /> :</th> <td> <xsl:value-of select="//tei:respStmt[2]/tei:name" /> </td>
            </tr>
            <tr>
